...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid: 'image', name: 'image', content: 'https://freestuffbot.xyz/assets/icons/180.png' },
      ...
      { hid: 'og:image', property: 'og:image', content: 'https://freestuffbot.xyz/assets/icons/180.png' },
