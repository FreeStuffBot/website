<template>
  <div id="content">
    <div id="infobox">
      <h1>Free Stuff <div class="bottag">BOT</div></h1>
      <h2>Get notifications about free games<br>right into your Discord server!</h2>

      <div class="divider" />

      <div class="box">
        <h3 id="quick-setup" style="color: #00f0a5">Getting Started</h3>
        <h4>Step one:</h4>
        <span>Invite the bot to your server by <a href="https://discord.com/oauth2/authorize?redirect_uri=https%3A%2F%2Ffreestuffbot.xyz%2Fcallback&client_id=672822334641537041&permissions=445504&scope=bot&response_type=code" rel="noreferrer">clicking here</a></span>
        <h4>Step two:</h4>
      ...
      <div class="box">
        ...
        <h4>Bottom text.</h4>
        <span><a href="/legal/privacy" rel="noreferrer">FreeStuff Privacy Policy</a> - <a href="/legal/terms" rel="noreferrer">FreeStuff Terms of Service</a></span>
      </div>
